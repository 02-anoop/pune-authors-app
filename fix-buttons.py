...
def fix_file():
    ...
    # Part 2: Replace Location cell and add Actions cell at the end
    ...
    # Part 3: Remove action buttons from expanded detail card
    ...
    content = content.replace(target_expanded_actions, replacement_expanded_actions)
