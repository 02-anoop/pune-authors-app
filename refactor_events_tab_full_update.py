               ...
               {selectedAuthorForData ? (
                  <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 shadow-sm animate-in fade-in slide-in-from-right-4 duration-300">
                     ...
                     <div className="space-y-4">
                        ...
                        {(selectedAuthorForData.books || [{title: 'Example Book Title'}]).map((book: any, idx: number) => (
                          <div key={idx} className="border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm hover:shadow transition-shadow">
                             ...
                             <div className="p-4 bg-gray-50 grid grid-cols-2 md:grid-cols-5 gap-4">
                                <div>
                                   ...
                                   <input type="number" defaultValue="0" className="w-full border border-gray-300 rounded p-2 text-sm font-mono" />
                                </div>
                                <div>
                                ...
                                <div>
                                   ...
                                   <input type="number" defaultValue="0" className="w-full border border-emerald-200 bg-emerald-50 text-emerald-700 rounded p-2 text-sm font-mono font-bold" />
                                </div>
                                <div>
                                 ...
                                 {authors.filter((a: any) => a.name.toLowerCase().includes(authorSearch.toLowerCase())).slice(0, 50).map((a: any, i: number) => (
                                     <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                                         ...
                                         <td className="p-3 text-center">
                                             <button onClick={() => setSelectedAuthorForData(a)} className="text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 px-3 py-1.5 rounded-lg font-bold border border-indigo-200 transition-colors shadow-sm">
                                                 Edit
                                             </button>
                                         </td>
                                     </tr>
