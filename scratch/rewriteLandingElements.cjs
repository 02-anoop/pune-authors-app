...
const newReturn = `  return (
    <main style={{ fontFamily: "'Google Sans', sans-serif", background: "#fff", color: "#111", overflowX: "hidden" }}>
      ...
      <section className="bg-mesh-light" style={{ backgroundColor: "#FFD400", padding: "6rem 2rem", position: "relative", overflow: "hidden" }}>
        ...
        <div className="animate-float" style={{ position: "absolute", top: "10%", left: "5%", width: "80px", height: "80px", borderRadius: "50%", background: "#00C2FF", opacity: 0.2, zIndex: 0 }}></div>
        <div className="animate-float-delayed" style={{ position: "absolute", bottom: "20%", right: "8%", width: "120px", height: "120px", background: "#FF7A00", borderRadius: "24px", transform: "rotate(15deg)", opacity: 0.2, zIndex: 0 }}></div>
        <div className="animate-float" style={{ position: "absolute", top: "40%", right: "40%", width: "40px", height: "40px", borderRadius: "50%", border: "6px solid #FF6B6B", opacity: 0.3, zIndex: 0 }}></div>
...
console.log("LandingPage.tsx updated with floating background elements and view all button hover states");
