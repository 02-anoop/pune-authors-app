...
const newReturn = `  return (
    <main style={{ fontFamily: "'Google Sans', sans-serif", background: "#fff", color: "#111", overflowX: "hidden" }}>
      ...
      {/* ════════════════════════════════════════════
          FICTION — ONE ROW, NAVIGATION ARROWS
      ════════════════════════════════════════════ */}
      ...
      <section className="bg-mesh-light" style={{ backgroundColor: "#FF7A00", padding: "6rem 2rem", position: "relative" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 10 }}>
          <FadeIn delay={100}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "2rem", marginBottom: "3rem" }}>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", gap: "0.5rem", marginRight: "1rem" }}>
                  <button onClick={() => document.getElementById('scroll-fiction').scrollBy({left: -600, behavior: 'smooth'})} className="nav-btn" style={{ background: "rgba(255,255,255,0.2)", border: "none" }}>
            ...
            {/* ONE ROW SCROLL */}
            <div id="scroll-fiction" className="hide-scrollbar" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "1rem", alignItems: "stretch", scrollSnapType: "x mandatory" }}>
              {galleryItems.filter(b => b.genre === "F").slice(0, 10).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} className="hover-lift" style={{ scrollSnapAlign: "start", flex: "0 0 240px", display: "flex", flexDirection: "column", textDecoration: "none", background: "#fff", padding: "1rem", borderRadius: "20px", boxShadow: "0 10px 20px rgba(0,0,0,0.1)", transition: "all 0.3s ease" }}>
      ...
      <section className="bg-graph" style={{ padding: "6rem 2rem", position: "relative", borderTop: "1px solid #eaeaea", borderBottom: "1px solid #eaeaea" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 10 }}>
          <FadeIn delay={200}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "2rem", marginBottom: "3rem" }}>
              ...
              <div style={{ order: 1, display: "flex", alignItems: "center", gap: "1rem" }}>
                ...
                <div style={{ display: "flex", gap: "0.5rem", marginLeft: "1rem" }}>
                  <button onClick={() => document.getElementById('scroll-nf').scrollBy({left: -600, behavior: 'smooth'})} className="nav-btn" style={{ background: "#eaeaea", border: "none" }}>
            ...
            {/* TWO ROW SCROLL */}
            <div id="scroll-nf" className="hide-scrollbar" style={{ display: "grid", gridTemplateRows: "1fr 1fr", gridAutoFlow: "column", gap: "1.5rem", overflowX: "auto", paddingBottom: "1rem", scrollSnapType: "x mandatory" }}>
              {galleryItems.filter(b => b.genre === "NF").slice(0, 16).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} style={{ scrollSnapAlign: "start", width: "320px", display: "flex", gap: "1.2rem", background: "#fff", padding: "1.2rem", border: "1px solid #eaeaea", borderRadius: 16, textDecoration: "none", transition: "all 0.3s ease" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-5px)"; e.currentTarget.style.boxShadow = "0 15px 30px rgba(0,51,255,0.08)"; e.currentTarget.style.borderColor = "#0033FF"; }} onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; e.currentTarget.style.borderColor = "#eaeaea"; }}>
      ...
      {/* ════════════════════════════════════════════
          CHILDREN'S CORNER — TOYS BACKGROUND
      ════════════════════════════════════════════ */}
      {galleryItems.filter(b => b.genre === "C").length > 0 && (
      <section className="bg-mesh-light" style={{ backgroundColor: "#FFD400", padding: "6rem 2rem", position: "relative", overflow: "hidden" }}>
          ...
          <FadeIn delay={300}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "3rem", flexWrap: "wrap", gap: "2rem" }}>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                {/* Custom Left/Right Navigation */}
                <div style={{ display: "flex", gap: "0.5rem", marginRight: "1rem" }}>
                  <button onClick={() => document.getElementById('scroll-children').scrollBy({left: -600, behavior: 'smooth'})} className="nav-btn" style={{ background: "rgba(0,0,0,0.1)", border: "none" }}>
                    <ArrowRight size={20} color="#111" style={{ transform: "rotate(180deg)" }} />
                  </button>
                  <button onClick={() => document.getElementById('scroll-children').scrollBy({left: 600, behavior: 'smooth'})} className="nav-btn" style={{ background: "rgba(0,0,0,0.1)", border: "none" }}>
                    <ArrowRight size={20} color="#111" />
            ...
            {/* ONE ROW SCROLL */}
            <div id="scroll-children" className="hide-scrollbar" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "1rem", alignItems: "stretch", scrollSnapType: "x mandatory" }}>
              {galleryItems.filter(b => b.genre === "C").slice(0, 10).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} className="hover-lift" style={{ scrollSnapAlign: "start", flex: "0 0 320px", display: "flex", flexDirection: "row", gap: "1.2rem", textDecoration: "none", background: "#fff", borderRadius: "20px", padding: "1.2rem", transition: "all 0.3s ease", border: "1px solid #eaeaea", alignItems: "center", boxShadow: "0 10px 20px rgba(0,0,0,0.05)" }}>
          ...
          <FadeIn>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "3rem", flexWrap: "wrap", gap: "2rem" }}>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                {/* Custom Left/Right Navigation */}
                <div style={{ display: "flex", gap: "0.5rem", marginRight: "1rem" }}>
                  <button onClick={() => document.getElementById('scroll-new').scrollBy({left: -600, behavior: 'smooth'})} className="nav-btn" style={{ background: "#f5f5f5", border: "none" }}>
                    <ArrowRight size={20} color="#111" style={{ transform: "rotate(180deg)" }} />
                  </button>
                  <button onClick={() => document.getElementById('scroll-new').scrollBy({left: 600, behavior: 'smooth'})} className="nav-btn" style={{ background: "#f5f5f5", border: "none" }}>
                    <ArrowRight size={20} color="#111" />
            ...
            {/* ONE ROW SCROLL */}
            <div id="scroll-new" className="hide-scrollbar" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "1rem", alignItems: "stretch", scrollSnapType: "x mandatory" }}>
              {[...galleryItems].reverse().slice(0, 10).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} className="hover-lift" style={{ scrollSnapAlign: "start", flex: "0 0 240px", display: "flex", flexDirection: "column", textDecoration: "none", position: "relative", background: "#fff", padding: "1rem", borderRadius: "20px", border: "1px solid #eaeaea", transition: "all 0.3s ease" }} onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 20px 40px rgba(0,0,0,0.08)"; e.currentTarget.style.borderColor = "#00D084"; }} onMouseLeave={e => { e.currentTarget.style.boxShadow = "none"; e.currentTarget.style.borderColor = "#eaeaea"; }}>
      ...
      ════════════════════════════════════════════ */}
      <section className="bg-mesh-light" style={{ backgroundColor: "#111", padding: "8rem 2rem", position: "relative" }}>
...
console.log("LandingPage.tsx updated with navigation arrows, grid-mesh, 2 rows for NF, dark theme form, and toys in Children section");
