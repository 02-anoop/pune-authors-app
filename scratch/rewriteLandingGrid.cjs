          ...
          <FadeIn delay={100}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem", alignItems: "stretch" }}>
              {galleryItems.filter(b => b.genre === "F").slice(0, 8).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} style={{ display: "flex", flexDirection: "column", textDecoration: "none", background: "#fff", padding: "1.2rem", borderRadius: "24px", boxShadow: "0 15px 30px rgba(0,0,0,0.1)", transform: "translateY(0)", transition: "transform 0.3s ease, box-shadow 0.3s ease", height: "100%" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-8px)"; e.currentTarget.style.boxShadow = "0 20px 40px rgba(0,0,0,0.15)"; }} onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 15px 30px rgba(0,0,0,0.1)"; }}>
      ...
      <section style={{ background: "#FFD400", padding: "6rem 2rem", position: "relative" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 10 }}>
          <FadeIn delay={300}>
            ...
            {/* Horizontal, playful cards in a GRID (No carousel) */}
              ...
              {galleryItems.filter(b => b.genre === "C").slice(0, 8).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} style={{ display: "flex", flexDirection: "row", gap: "1.5rem", textDecoration: "none", background: "#fff", borderRadius: "24px", padding: "1.2rem", boxShadow: "8px 8px 0 #00C2FF", transform: "translateY(0) translateX(0)", transition: "all 0.2s ease", border: "3px solid #111", alignItems: "center", height: "100%" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px) translateX(-4px)"; e.currentTarget.style.boxShadow = "12px 12px 0 #00C2FF"; }} onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0) translateX(0)"; e.currentTarget.style.boxShadow = "8px 8px 0 #00C2FF"; }}>
                  ...
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100%", justifyContent: "center" }}>
                    ...
                    <div style={{ background: "#FF6B6B", color: "#fff", padding: "0.5rem 1rem", borderRadius: "50px", textAlign: "center", fontWeight: 900, fontSize: 14, border: "2px solid #111", width: "fit-content", marginTop: "auto" }}>
          ...
          <FadeIn>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "2rem", alignItems: "stretch" }}>
              {[...galleryItems].reverse().slice(0, 8).map((book, i) => (
                <Link key={i} to={\`/book/\${book.id}\`} className="group" style={{ display: "flex", flexDirection: "column", textDecoration: "none", position: "relative", height: "100%" }}>
...
console.log("LandingPage.tsx updated to grid layout without carousels");
