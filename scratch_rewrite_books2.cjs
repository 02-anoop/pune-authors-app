          ...
          {isLoadingBooks ? (
            ...
            <FadeIn delay={50}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                ...
                <Link to="/catalogue?category=All" style={{ fontSize: 14, fontWeight: 700, color: C.dark, textDecoration: "none", display: "flex", alignItems: "center", gap: "0.4rem", background: C.gold, padding: "0.6rem 1.2rem", borderRadius: "50px" }}>
          ...
          {!isLoadingBooks && galleryItems.filter(b => b.genre === "F").length > 0 && (
            <FadeIn delay={100}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                ...
                <Link to="/catalogue?category=Fiction" style={{ fontSize: 14, fontWeight: 700, color: C.dark, textDecoration: "none", display: "flex", alignItems: "center", gap: "0.4rem", background: C.white, padding: "0.6rem 1.2rem", borderRadius: "50px" }}>
                  View Fiction <ArrowRight size={16} />
                </Link>
              </div>
              <div className="horizontal-scroll" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "2rem", scrollbarWidth: "none", WebkitOverflowScrolling: "touch", alignItems: "flex-start" }}>
          ...
          {!isLoadingBooks && galleryItems.filter(b => b.genre === "NF").length > 0 && (
            <FadeIn delay={200}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                ...
                <Link to="/catalogue?category=Non-Fiction" style={{ fontSize: 14, fontWeight: 700, color: C.dark, textDecoration: "none", display: "flex", alignItems: "center", gap: "0.4rem", background: C.gold, padding: "0.6rem 1.2rem", borderRadius: "50px" }}>
                  View Non-Fiction <ArrowRight size={16} />
                </Link>
              </div>
              <div className="horizontal-scroll" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "2rem", scrollbarWidth: "none", WebkitOverflowScrolling: "touch", alignItems: "flex-start" }}>
          ...
          {!isLoadingBooks && galleryItems.filter(b => b.genre === "C").length > 0 && (
            <FadeIn delay={300}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                ...
                <Link to="/catalogue?category=Children's corner" style={{ fontSize: 14, fontWeight: 700, color: C.white, textDecoration: "none", display: "flex", alignItems: "center", gap: "0.4rem", background: C.dark, padding: "0.6rem 1.2rem", borderRadius: "50px" }}>
                  View Children's <ArrowRight size={16} />
                </Link>
              </div>
              <div className="horizontal-scroll" style={{ display: "flex", gap: "1.5rem", overflowX: "auto", paddingBottom: "2rem", scrollbarWidth: "none", WebkitOverflowScrolling: "touch", alignItems: "flex-start" }}>
