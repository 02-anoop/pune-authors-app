                ...
                return (
                  <React.Fragment key={book.id}>
                    <tr className={isExpanded ? 'bg-gray-50' : ''}>
                      <td className="text-gray-500 text-center">{sNo}</td>
                      <td>
                        <div className="flex items-center gap-3">
                          {hasDistribution ? (
                            <button
                      ...
                      <td className="text-center">{book.eventQty}</td>
                      ...
                      <td className="text-center">
                        {book.isLowStock ? (
                          <button
                            ...
                            className={`flex items-center justify-center gap-1.5 w-full py-1.5 px-2 rounded-lg text-xs font-bold transition-all ${isPinged
