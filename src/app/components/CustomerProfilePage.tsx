...
import { User, LogOut, Package, ArrowRight, Calendar } from "lucide-react";
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "2rem" }} className="profile-grid">
          ...
          <div>
            ...
            <div style={{ background: "#fff", borderRadius: 16, border: "1px solid rgba(0,0,0,0.07)", overflow: "hidden", boxShadow: "0 4px 12px rgba(0,0,0,0.03)", marginTop: "2rem" }}>
              <div style={{ padding: "1.5rem", borderBottom: "1px solid rgba(0,0,0,0.05)", display: "flex", alignItems: "center", gap: "0.6rem" }}>
                <Calendar size={20} color="#b44d28" />
                <h2 style={{ fontFamily: "var(--font-display)", fontSize: 18, fontWeight: 700, color: "#1a1a2e" }}>Your Registered Events</h2>
              </div>
              
              {registrations.length === 0 ? (
                <div style={{ padding: "3rem 2rem", textAlign: "center" }}>
                  <div style={{ width: 64, height: 64, background: "#fff5f0", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1rem" }}>
                    <Calendar size={28} color="#b44d28" />
                  </div>
                  <h3 style={{ fontSize: 16, fontWeight: 600, color: "#1a1a2e", marginBottom: "0.5rem" }}>No upcoming events registered</h3>
                  <p style={{ fontSize: 13, color: "#6b6b80", marginBottom: "1.5rem" }}>You haven't RSVP'd to any events yet.</p>
                  <Link to="/events" style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "#1a1a2e", color: "#fff", textDecoration: "none", padding: "0.7rem 1.4rem", borderRadius: 8, fontSize: 13, fontWeight: 600 }}>
                ...
                <div style={{ overflowX: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    <thead>
                      <tr style={{ background: "#f7f7f9", borderBottom: "1px solid rgba(0,0,0,0.05)", textAlign: "left" }}>
                        <th style={{ padding: "1rem 1.5rem", fontSize: 12, fontWeight: 600, color: "#6b6b80", textTransform: "uppercase", letterSpacing: "0.05em" }}>Event Name</th>
                        <th style={{ padding: "1rem 1.5rem", fontSize: 12, fontWeight: 600, color: "#6b6b80", textTransform: "uppercase", letterSpacing: "0.05em" }}>Event Date</th>
                        <th style={{ padding: "1rem 1.5rem", fontSize: 12, fontWeight: 600, color: "#6b6b80", textTransform: "uppercase", letterSpacing: "0.05em" }}>RSVP Date</th>
                        <th style={{ padding: "1rem 1.5rem", fontSize: 12, fontWeight: 600, color: "#6b6b80", textTransform: "uppercase", letterSpacing: "0.05em" }}>Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      {registrations.map((reg) => (
                        <tr key={reg.id} style={{ background: "#fff", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                          <td style={{ padding: "1rem 1.5rem", fontSize: 13, color: "#1a1a2e", fontWeight: 700 }}>
                            {reg.eventTitle}
                          </td>
                          <td style={{ padding: "1rem 1.5rem", fontSize: 13, color: "#444" }}>
                            {reg.eventDate}
                          </td>
                          <td style={{ padding: "1rem 1.5rem", fontFamily: "var(--font-mono)", fontSize: 12, color: "#6b6b80" }}>
                          ...
                          <td style={{ padding: "1rem 1.5rem" }}>
                            <span style={{ background: "#f0fdf4", color: "#16a34a", padding: "0.25rem 0.6rem", borderRadius: 6, fontSize: 11, fontWeight: 700, border: "1px solid #bbf7d0" }}>
                              RSVP'd ✓
                            </span>
                          </td>
                        </tr>
