      ...
      {viewingGalleryImage && (() => {
        ...
        return (
          <div className="fixed inset-0 z-[100] bg-black/90 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setViewingGalleryImage(null)}>
            ...
            <img src={viewingGalleryImage} className="max-w-full max-h-[90vh] object-contain rounded-lg shadow-2xl transition-transform" alt="Gallery Fullscreen" onClick={(e) => e.stopPropagation()} />
