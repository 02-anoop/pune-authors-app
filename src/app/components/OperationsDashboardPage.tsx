    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-paa-navy/5 shadow-premium hover:shadow-premium-hover transition-all duration-500 ease-out flex flex-col">
        ...
        <div className="hidden md:block w-full overflow-hidden">
          <table className="dash-table w-full table-fixed">
            ...
            <tbody>
              ...
              {filteredOrders.length === 0 && <tr><td colSpan={6} className="text-center py-8">No orders yet.</td></tr>}
            </tbody>
          </table>
        </div>
        ...
        <div className="md:hidden flex flex-col gap-4 p-4 bg-gray-50">
          ...
          {filteredOrders.length === 0 && <div className="text-center py-8 text-sm text-gray-500 italic">No matching orders found.</div>}
        </div>
