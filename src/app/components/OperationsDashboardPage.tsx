      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative" style={{ background: '#f5f5f3' }}>
        ...
        <div id="admin-dashboard-scroll" className="flex-1 overflow-auto p-4 sm:p-7">
          <Suspense fallback={<div className="p-10 text-center text-gray-500 font-medium">Loading module...</div>}>
            ...
            {activeTab === 'authors' && <Suspense fallback={<div className='p-10 text-center animate-pulse'>Loading Authors...</div>}><AdminAuthorsTabLazy authors={authors} API={API} selectedAuthorIds={selectedAuthorIds} setSelectedAuthorIds={setSelectedAuthorIds} isDownloadingPdf={isDownloadingPdf} setIsDownloadingPdf={setIsDownloadingPdf} authorSearchTerm={searchTerm} setAuthorSearchTerm={setSearchTerm} authorStatusFilter={authorStatusFilter} setAuthorStatusFilter={setAuthorStatusFilter} setAuthorsPage={setAuthorsPage} fetchAuthors={fetchAuthors} loadingAction={loadingAction} handleApproveAuthor={handleApproveAuthor} openRejectAuthorModal={openRejectAuthorModal} handleViewEditAuthor={handleViewEditAuthor} handleDeleteAuthor={handleDeleteAuthor} books={books} authorsMeta={authorsMeta} authorsPage={authorsPage} /></Suspense>}
